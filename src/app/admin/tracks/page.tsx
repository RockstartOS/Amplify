              ...
              <form action={updateTrackAction} className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="h-9 w-12 cursor-pointer rounded border border-black/15"
                  />
                  <input
                    name="name"
                    defaultValue={track.name}
                    className="flex-1 rounded-lg border border-black/15 px-3 py-2 font-semibold outline-none focus:border-brand"
                  />
